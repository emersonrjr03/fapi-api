...
import com.herms.service.AttributeValidationService;
...
@Path("/validation")
public class AttributeValidationResource {
    @Inject
    AttributeValidationService service;
    ...
    @Path("{id}")
    @Transactional
    public Response update(@PathParam("id") Long id, AttributeValidation model) {
